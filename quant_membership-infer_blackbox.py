...
for target_class in classes:
    ...
    for final_model in models:
        ...
        train_indices = [i for i, (_, target) in enumerate(train_dataset) if target == target_class][:100]
        test_indices = [i for i, (_, target) in enumerate(test_dataset) if target == target_class][:100]
